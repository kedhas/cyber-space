export default function ContactUs() {
    return (
        <div id="contact-us" className="w-full draggable">
                ...
                <div className="grid items-center grid-cols-1 gap-16 lg:grid-cols-2">
                    <div className="flex flex-col gap-16">
                        ...
                        <div className="grid w-full grid-cols-2 gap-x-5 gap-y-16">
                            ...
                            <div className="flex flex-col items-center gap-3 text-center md:text-start md:items-start">
                                ...
                                <a className="text-lg font-bold text-purple-500" target="_blank">
                                    08:00 AM-10:00 PM
                                </a>
                            </div>
                        </div>
                    ...
                    <div className="flex flex-col gap-5 p-10 bg-white rounded-3xl shadow-main">
                        ...
                        <form className="flex flex-col gap-6">
                            ...
                            <button type="submit" className="flex items-center justify-center py-4 text-center text-white px-7 rounded-2xl bg-purple-500 hover:bg-purple-600 focus:ring-4 focus:ring-purple-100 transition duration-300">
                                Submit message
                            </button>
                        </form>
                    </div>
